package com.amitsapplication.app.appcomponents.utility
...
class PreferenceHelper {
  ...
  fun setQwq(paramValue: String?) {
    with(sharedPreference.edit()) {
      this.putString("qwq", paramValue!!)
      apply()
    }
  }

  fun getQwq(): String? = sharedPreference.getString("qwq", null)
}
